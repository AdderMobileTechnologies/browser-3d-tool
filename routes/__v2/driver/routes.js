...
//  ROUTE METRICS: NONE
router.post('/', passport.authenticate('DriverStrategy', {session: false}), async function(req, res) {
    ...
    const {dv, type, last_updated, created, idb_complete, ro, pts } = req.body;
    ...
    formattedRoute.dv = dv;
	  formattedRoute.ro = ro 
    formattedRoute.ro.dref = driverId
	  formattedRoute.io = [];
