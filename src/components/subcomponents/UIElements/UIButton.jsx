    ...
    render() {
        ...
        switch (this.props.iconName) {
            ...
            case "landscape":
                    ...
                    src = Landscape;
                   // break;
                    return <input type={"image"} onClick={this.props.onClick} alt={alt} src={src} style={{...iconStyle.small}}/>;
            case "location_city":
                            alt = "location_city";
                            src = Location_City;
                           // break;
            ...
            case "format_color_fill":
                return (
                    <form onSubmit={(formSubmitEvent) => {
                        ...
                        <button className={this.props.classNames} type="submit">
                            <Avatar>
                                <FormatColorFill fontSize={"small"} onClick={this.props.onClick}/>
                            </Avatar>
                        </button>
                    </form>
                );
        ...
        return <input type={"image"} onClick={this.props.onClick} alt={alt} src={src} style={{...iconStyle.common}}/>;
    }
}
