...
class AdderMeshWrapper {
  ...
  applyTextureFromDataURL(imgFileName = null, dataURL = null, scene = null) {
    ...
    ///////////////////----------------------------------------------------
    /////////////////////////////////////////////////
    //  let texTest = Texture.CreateFromBase64String(dataURL, imgFileName, scene);

    /*
    let mesh_material = new StandardMaterial(mesh.id, _scene);
    //mesh_material.diffuseColor = new BABYLON.Color3(0, 0, 0);
    mesh_material.specularTexture = Texture.CreateFromBase64String(
      _dataURL,
      mesh.id
    );
    mesh_material.emissiveTexture = Texture.CreateFromBase64String(
      _dataURL,
      mesh.id
    );
...
//--- Apply Base64 Image  ---------------
     static apply_Base64ToMesh(scene, mesh,  image_data){
         ...
         let mesh_material = new BABYLON.StandardMaterial(mesh.id, scene);
         mesh_material.diffuseColor = new BABYLON.Color3(0, 0, 0);
...
MESH WRAPPER UUID:  Mon Sep 09 2019 15:09:42 GMT-0400 (Eastern Daylight Time)
MESH WRAPPER UUID:  Mon Sep 09 2019 15:10:25 GMT-0400 (Eastern Daylight Time)
*/
