...
class VerifyRecoveredPassword extends React.Component {
  ...
  handleFormSubmit(e) {
    ...
    axios(config)
      ...
      .catch(error => {
        alert(
          "We apologize, but we were unable to reset your password at this time. Please try again."
        );
      });
  }

  componentDidMount() {
    this.state.pwdRecoverURL = this.props.location.search
      .split("?")[1]
      .split("=")[1];
  }
